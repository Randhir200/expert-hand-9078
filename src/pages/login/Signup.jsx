        ...
        <Box display={'block'} margin='auto'>
          ...
          >
            ...
            >
              <Flex justifyContent={'space-around'} alignItems='center'>
                <Image
                  ...
                  boxSize={'20px'}
                />
                <Text p='5px' fontSize='12px' fontWeight='500'>
                  Sign in with Goggle
                </Text>
              </Flex>
            </Button>
            ...
            >
              <Flex justifyContent={'space-around'} alignItems='center'>
                <Image
                  src='https://pbs.twimg.com/profile_images/1268237607147728896/1CRvsTJ1_400x400.png'
                  boxSize={'20px'}
                />
                <Text p='5px' fontSize='12px' fontWeight='500'>
            ...
            <Text p='5px' fontSize='14px' fontWeight='500'>
